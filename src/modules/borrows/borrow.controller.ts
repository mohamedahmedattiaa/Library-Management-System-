...
export class BorrowController {
  ...
  myBorrows = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const id = req.user!.userId;
  ...
  myHistory = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const id = req.user!.userId;
  ...
  overdue = async (req: Request, res: Response, next: NextFunction) => {
    try {
